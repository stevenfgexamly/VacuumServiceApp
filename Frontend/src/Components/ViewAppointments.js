...
import { Modal, NavbarDropDown, Container, Card, ButtonGroup, Button, Table, Row, Col, Form } from 'react-bootstrap';
...
function ViewAppointments() {
    ...
    const getAppointments = () => {
        axios.get("http://localhost:8080/api/getAppointments?uid=" + uid)
                                            ...
                                            <Row>
                                                {
                                                    appointment.status == "Paid" ?
                                                        ...
                                                        :
                                                        <Col>
                                                            <Button onClick={payAppointment(appointment.aid)} size="lg" variant="primary" style={{ marginRight: '1rem' }} className='float-left' type="button">Pay ${appointment.bill.finalprice}</Button>
                                                        </Col>
                                                }
                                                <Col>
